...

  {
    ...
    members: [
...

      {
        ...
        linkedInUrl: 'https://www.linkedin.com/in/johnnie-tse-10a9b91b0/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3Bw3K1GK35Qe23A9OupU2c6w%3D%3D',
      },
...
export default function Team() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      <h2 className="text-3xl font-bold mb-8 text-center" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>Meet Our Team</h2>
      {teamMembers.map((section, sectionIndex) => (
        <div key={sectionIndex} className="mb-12">
          ...
          <div className="flex justify-center">
            <div
              className={`flex flex-wrap justify-center gap-8 ${section.members.length === 1
                  ? 'grid-cols-1'
