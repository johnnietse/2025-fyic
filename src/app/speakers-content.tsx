      ...
      <div className="container mx-auto">
        ...
        {selectedImage !== null && (
          <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center p-4">
            ...
            <div
              ref={iconRef}
              className={`fixed z-60 bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-full p-3 shadow-2xl cursor-pointer transition-all duration-200 ${isDraggingIcon ? 'scale-110 shadow-xl' : 'hover:scale-105'
                }`}
              style={{
            ...
            {/* Image Container */}
            <div
              className="max-w-full max-h-full overflow-auto cursor-zoom-in mt-8 mb-32 md:mb-0 md:mt-0 relative h-[90vh] w-[90vw]"
              onWheel={handleWheel}
            >
              <Image
