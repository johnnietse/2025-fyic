      ...
      <section className="relative z-10 container mx-auto px-4 py-16">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          ...
          <div className="relative bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20">
            {/* Main Image Display */}
            <div className="h-64 md:h-96 rounded-lg overflow-hidden mb-4 relative">
              <Image
            ...
            <div className="flex justify-center space-x-4 mt-4">
              {conferenceImages.map((img, index) => (
                <button
                  ...
                  className={`w-16 h-16 rounded overflow-hidden border-2 relative ${activeImage === index ? 'border-blue-400' : 'border-transparent'}`}
                >
                  <Image
                    src={img}
